...
if __name__ == '__main__':
    ...
    with Sweep(Args) as sweep:
        ...
        Args.use_critic_fourier_features = True
    ...
    for i, deps in sweep.items():
        ...
        os.environ["ML_LOGGER_ROOT"] = f"{os.getcwd()}/results/bvn/" + str(deps['Args.use_critic_fourier_features']) + f"-256-share_state/{deps['Args.env_name']}/{deps['Args.seed']}"
        main(deps)
